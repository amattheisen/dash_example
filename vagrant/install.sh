...
# =====================================
su - ${RUSER} -c "/opt/conda/envs/${TOOL}/bin/pip install -q -r /opt/${TOOL}/requirements.pip"
...
semanage fcontext -a -t httpd_sys_rw_content_t "/opt/${TOOL}/static_dash"
...
ln -sf -T /opt/${TOOL}/vagrant/${TOOL}-nginx.conf /etc/nginx/conf.d/${TOOL}.conf
